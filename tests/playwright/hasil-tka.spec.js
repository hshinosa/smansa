...
test.describe('Hasil TKA Page (Redirect to Integrated)', () => {
  test('should redirect to integrated Prestasi Akademik page', async ({ page }) => {
    await page.goto('/akademik/prestasi-akademik/hasil-tka');
  ...
  test('should display Hasil Ujian section on integrated page', async ({ page }) => {
    await page.goto('/akademik/prestasi-akademik/hasil-tka');
